					...
					{status === 'searching_courier' ? (
						...
						<div className="text-center">
							<p className="ajax-response success mb-4" style={{ color: '#28a745', fontWeight: '600' }}>
								{queueMode === 'priority'
									? 'Заявка принята, но приоритет активируется только после успешной оплаты. Если платёжная страница не открылась, заявка остаётся без подтверждённой предоплаты.'
									: isPartnerApplication
