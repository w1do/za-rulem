...
export const buildGasPricesFaqs = (city: ChatCity): GasPricesFaq[] => [
	...
	},
	{
		...
		answer:
			'Текущие цены загружаются из публичного источника 2GIS, а для истории один раз в сутки сохраняется агрегированный снимок по городу и сети. В карточке указана дата обновления исходных цен.',
	},
	{
